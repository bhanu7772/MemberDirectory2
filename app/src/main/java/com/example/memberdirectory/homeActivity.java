...
import com.example.memberdirectory.MYAdapter.MyRecycler;
...
RecyclerView recyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        strings.add("Student 10");
        MyRecycler MyRecycler = new MyRecycler(this, strings);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_editprofile) {
            Intent in1=new Intent(this,EditProfileActivity.class);
                    startActivity(in1);
